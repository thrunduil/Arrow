...
void CommonASTWithHiddenTokens::initialize(int t,const std::string& txt)
{
...
RefAST CommonASTWithHiddenTokens::factory(pool_parser pool)
{
	return RefAST(new(*pool,get_ptr<CommonASTWithHiddenTokens>()) CommonASTWithHiddenTokens());
}

RefAST CommonASTWithHiddenTokens::clone( pool_parser pool )
{
	CommonASTWithHiddenTokens *ast = new(*pool,get_ptr<CommonASTWithHiddenTokens>()) CommonASTWithHiddenTokens( *this );
	return RefAST(ast);
}
